        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <style>
                ...
                .col-xs-12.col-sm-9 {
                    margin-left: 22%;
                    padding: 0 60px;
                    /* giống khoảng cách mẫu (ngăn không cho sát vào mép)*/
                    box-sizing: border-box;
                }
                    ...
                    <div class="header-container">
                        ...
                        <nav class="main-nav">
                            <ul>
                                ...
                                <li class="menu-sp">
                                    <a href="${pageContext.request.contextPath}/SanPham-TatCa">Sản phẩm <span
                                            class="arrow">▾</span></a>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown-item">
                                            <a href="${pageContext.request.contextPath}/filter?categoryID=3">Hạt dinh
                                                dưỡng</a>
                                        </li>
                                        <li class="dropdown-item">
                                            <a href="${pageContext.request.contextPath}/filter?categoryID=2">Bánh dinh
                                                dưỡng</a>
                                        </li>
                                        <li class="dropdown-item">
                                            <a href="${pageContext.request.contextPath}/filter?categoryID=4">Trà gạo
                                                lứt</a>
                                        </li>
                                    </ul>
                        ...
                        <div class="user-actions">
                            ...
                            <c:choose>
                             ...
                             C20 14.5714 15.3137 13 12 13Z" fill="#333" />
                                        </svg>
                                    </a>
                                    ...
                                    <div id="accountMenu" class="account-menu">
                                        ...
                                        <div class="account-menu_inner">
                                            ...
                                            <hr>
                                            <a href="<c:url value='/TaiKhoanCuaBan'/>" class="account-menu_link">Thông
                                                tin tài khoản</a>
                                ...
                                <c:otherwise>
                                    <a href="<c:url value='/DangNhapTaiKhoan'/>" class="account-btn"
                ...
                <main class="mainContainer-theme">
                                    ...
                                    <div class="AccountContent">
                                        <div class="AccountList">
                                            <ul class="list-unstyled">
                                                <li><a href="<c:url value='/TaiKhoanCuaBan'/>">Thông tin tài khoản</a>
                                                </li>
                                                <li><a href="<c:url value='/DanhSachDiaChi'/>">Danh sách địa chỉ</a>
                                                </li>
                                                <li class="current"><a href="<c:url value='/ChuKySo'/>">Chữ ký số</a>
                                                </li>
                    ...
                    <div class="col-xs-12 col-sm-9">
                                                    ...
                                                    <form id="revokeForm" action="<c:url value='/ChuKySo'/>"
                                                        ...
                                                        <div class="ds-alert-warning">
                                                            <p class="ds-warning-text">
                                                                <strong>Cảnh báo:</strong> Nếu bạn nghi ngờ khoá bảo
                                                                mật bị lộ, hãy báo mất ngay lập tức. Hành động này
                                                                không thể hoàn tác!
                                                            </p>
                                                        </div>
                        ...
                        <div class="modal fade" id="confirmRevokeModal" tabindex="-1"
                            aria-labelledby="confirmRevokeModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer ds-modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Huỷ
                                            bỏ</button>
                                        <button type="button" class="btn btn-danger" id="confirmSubmitBtn">Báo mất
                                            ngay</button>
                                    </div>
                                    ...
                                    <div class="form-newsletter">
                                        <form accept-charset="UTF-8" action="/account/contact" class="contact-form"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button type="submit"
                                                    class="button dark submitNewsletter"><span>Gửi</span></button>
                                            </div>
                                        ...
                                        <div class="boxlink ft-col col-md-3 col-sm-6 col-xs-12">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="DieuKhoanDichVu" title="Điều khoản dịch vụ">Điều khoản dịch
                                                        vụ</a></li>
                                                <li><a href="ChinhSachThanhToan" title="Chính sách thanh toán">Chính
